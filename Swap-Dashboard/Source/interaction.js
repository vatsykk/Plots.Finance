...
async function Update(inputtype){
    ...
    document.getElementById("%").innerText = (((0.03)*((100)*(1000000))/(document.getElementById("EthCount").value * Ethprice) * 100)).toLocaleString(undefined, { maximumFractionDigits: 2 });
}
