...
async function Update(inputtype){
    ...
    document.getElementById("%").innerText = (((0.03)*((document.getElementById("ethers").value)*(1000000))/(document.getElementById("ETH").value * Ethprice) * 100)).toLocaleString(undefined, { maximumFractionDigits: 2 });
